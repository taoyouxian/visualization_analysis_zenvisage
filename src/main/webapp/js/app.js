...
/// <reference path="parsertypes.js" />
/// <reference path="query.js" />
/// <reference path="renderplot.js" />
/// <reference path="scatter.js" />
/// <reference path="zqlgraph.js" />
/// <reference path="zqlparser.js" /> 
...
app.controller('zqlTableController', ['$scope' ,'$http', 'plotResults', '$compile', function ($scope, $http, plotResults, $compile) {
    ...
    $scope.showZQLGraph = function () {
        $("#graph-div").empty(); 
        createZQLGraph(demoRowNum);
    };
    ...
    app.controller('options-controller', [
      ...
      function($scope, $rootScope, $http, ChartSettings, $compile){
          ...
          $scope.populateWeatherQuery1 = function() {
              ...
              $($( ".tabler" )[0]).find(".constraints").val("location='AUPERTH'")
              $($( ".tabler" )[0]).find(".process").val("")
          }
          ...
          $scope.populateWeatherQuery2 = function() {
              ...
              $($( ".tabler" )[1]).find(".process").val("v2<-argmax_{z1}[k=5]D(f1,f2)")
